...
import Img from "/images/pharmacist.jpg";
    ...
    <div className="bg-primary-100 p-20">
      ...
      <div className="relative">
        ...
        <div className="absolute top-0 right-0 flex flex-col items-center justify-between p-4 rounded-lg space-y-6 h-full">
          <div className="w-full bg-primary-100 p-6 px-14 rounded-lg shadow-xl hover:bg-primary-200 transition duration-300 flex items-center space-x-10 hover:scale-110">
